...
brick_sprites = ["element_green_rectangle.png", "element_purple_rectangle.png", "element_red_rectangle.png"]
middle_brick = ["element_yellow_rectangle.png"]
...
def update_elapsed_time():
    ...
    # IT gives the time you played the game and updates it
    elapsed_time = int(time.time() - start_time)


def update_paddle():
#this helps to move the mouse left or right as per mouse"s  movement
    global paddle
...
#This updates the position of the things given in the game 

    ball.x = ball.x + ball_x_speed
    ball.y = ball.y + ball_y_speed

    # checks wetherr the ball has hit the side walls
